  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input data-setting="api_key" type="password" spellcheck="false" id="yay_smtp_setting_smtpcom_api_key" class="yay-settings" value="<?php echo esc_attr($smtpcomApiKey); ?>">
    ...
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="sender" id="yay_smtp_setting_smtpcom_sender" class="yay-settings" value="<?php echo esc_attr($sender); ?>">
        <p class="setting-description">
          Click here to
