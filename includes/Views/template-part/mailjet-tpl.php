  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="api_key" id="yay_smtp_setting_mailjet_api_key" class="yay-settings" value="<?php echo esc_attr($apiKey); ?>">
    ...
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input data-setting="secret_key" type="password" spellcheck="false" id="yay_smtp_setting_mailjet_secret_key" class="yay-settings" value="<?php echo esc_attr($secretKey); ?>">
        <p class="setting-description">
          Click here to
