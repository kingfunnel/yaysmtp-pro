...
$showNetworkAdminMultisite = is_multisite() && is_network_admin() && ($allowMultisite == 'no') ? 'none' : 'block';
...
<h2 class="yaysmtp-multisite-mode"><?php echo __("YaySMTP - Multisite Mode", "yay-smtp") ?></h2>
<!-- Mail Logs page  -->
...
<div class="yay-smtp-wrap send-mail-settings-wrap">
  <div class="yay-smtp-header">
    ...
    <div class="yay-button-wrap yay-smtp-button-title" style="display: <?php echo $showNetworkAdminMultisite ?>">
  ...
  <div class="yay-smtp-content">
      ...
      <div class="yay-smtp-card-header">
        <div class="yay-smtp-card-title-wrapper">
          <h3 class="yay-smtp-card-title yay-smtp-card-header-item">
            <?php echo __('Multisite', 'yay-smtp'); ?>
          </h3>
        </div>
      </div>
      <div class="yay-smtp-card-body">
        <div class="setting-el">
          <div class="setting-label">
            <label for="yay_smtp_setting_multisite"><?php echo __('Allow SMTP settings for multisite', 'yay-smtp'); ?></label>
          </div>
          <div class="setting-multisite-field">
            <label class="switch">
              <input type="checkbox" id="yay_smtp_setting_multisite" <?php echo $allowMultisite == "yes" ? "checked" : "" ?>>
            ...
            <p class="setting-description">
              <?php echo __('If enable a multisite setting, each subsite will inherit the network admin SMTP settings. If disabled a multisite setting, each subsite of this multisite will have its own SMTP settings.', 'yay-smtp'); ?>             
            </p>
          </div>
        </div>
        </div>
    ...
    <div class="yay-smtp-general-settings-wrap" style="display: <?php echo $showNetworkAdminMultisite ?>">
      <div class="yay-smtp-card">
        <div class="yay-smtp-card-header">
          <div class="yay-smtp-card-title-wrapper">
