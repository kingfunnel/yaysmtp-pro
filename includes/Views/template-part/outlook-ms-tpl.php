  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="client_id" id="yay_smtp_setting_outlookms_client_id" class="yay-settings" value="<?php echo esc_attr($clientId); ?>">
      </div>
    </div>
    <div class="setting-el">
      <div class="setting-label">
      ...
      <div class="setting-field">
        <input data-setting="client_secret" type="password" spellcheck="false" id="yay_smtp_setting_outlookms_client_secret" class="yay-settings" value="<?php echo esc_attr($clientSecret); ?>">
      </div>
    </div>
    <div class="setting-el">
      <div class="setting-label">
      ...
      <?php if ($auth->clientIDSerect($mailer)) {?>
        <?php if ($auth->tokenEmpty($mailer) && "#" != $urlAuth) {?>
          ...
          <?php if( 'yes' !== $multisiteSetting && is_network_admin() ) { ?>
            <p class="setting-description"><?php echo __('If you are selecting On mode of multisite setting. Please save change to apply On mode before confirming authorization.', 'yay-smtp'); ?></p>
          <?php } ?>
        <?php } elseif("#" == $urlAuth) { 
