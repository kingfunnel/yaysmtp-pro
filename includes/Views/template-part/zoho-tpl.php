  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="client_id" id="yay_smtp_setting_zoho_client_id" class="yay-settings" value="<?php echo esc_attr($clientId); ?>">
      </div>
    </div>
    <div class="setting-el">
      <div class="setting-label">
      ...
      <div class="setting-field">
        <input data-setting="client_secret" type="password" spellcheck="false" id="yay_smtp_setting_zoho_client_secret" class="yay-settings" value="<?php echo esc_attr($clientSecret); ?>">
      </div>
    </div>
    <div class="setting-el">
      <div class="setting-label">
