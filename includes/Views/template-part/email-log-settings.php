          ...
          <div class="setting-el delete-time-el">
            <div class="setting-label">
              ...
              <div class="yay-tooltip icon-tootip-wrap">
                ...
                <span class="yay-tooltiptext yay-tooltip-bottom yay-tooltip-save-logs"><?php echo __('After x days, all logs will be deleted or not if forever option is selected.', 'yay-smtp'); ?></span>
              </div>
            </div>
            <div class="setting-field">
