  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input data-setting="api_key" type="password" spellcheck="false" id="yay_smtp_setting_mailgun_api_key" class="yay-settings" value="<?php echo esc_attr($mailgunApiKey); ?>">
    ...
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input type="text" data-setting="domain" id="yay_smtp_setting_mailgun_domain" class="yay-settings" value="<?php echo esc_attr($domain); ?>">
        <p class="setting-description">
          Click here to
