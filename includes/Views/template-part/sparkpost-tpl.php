  ...
  <div class="yay-smtp-card-body">
    <div class="setting-el">
      ...
      <div class="setting-field">
        <input data-setting="api_key" type="password" spellcheck="false" id="yay_smtp_setting_sparkpost_api_key" class="yay-settings" value="<?php echo esc_attr($sparkPostApiKey); ?>">
